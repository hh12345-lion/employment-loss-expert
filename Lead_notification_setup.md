...
## This project (Employment Loss Expert)

| Setting | Value |
|---------|--------|
| **`BRAND_NAME`** | `EmploymentLossExpert` |
| **`domain`** (when `NEXT_PUBLIC_SITE_URL=https://www.employmentlossexpert.com`) | `employmentlossexpert.com` |
| Contact webhook | **`/api/submit-lead`** with `formType: "contact"` |
| Outbound keys | `Full Name`, `Email`, `Phone Number`, `Brand name`, `domain` |
